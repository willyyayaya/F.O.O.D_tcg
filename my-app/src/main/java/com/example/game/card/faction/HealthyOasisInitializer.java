...
public class HealthyOasisInitializer implements FactionCardInitializer {
    ...
    private void initializeCharacterCards(Map<String, Card> allCards, List<CharacterCard> allCharacters) {
        ...
        CharacterCard saladWarrior = new CharacterCard(
            "沙拉戰士", 2, "【開胃】：為一個友方角色恢復1點生命值。【連擊】：攻擊後，有30%機率再次攻擊。", 
            Rarity.CASUAL_BITES, 2, 2, true, Faction.HEALTHY_OASIS);
        allCards.put(saladWarrior.getName(), saladWarrior);
        allCharacters.add(saladWarrior);
        
        CharacterCard smoothieMage = new CharacterCard(
            "冰沙法師", 3, "【開胃】：使一個友方角色獲得+1/+1。【連擊】：攻擊後，有40%機率再次攻擊。", 
            Rarity.GOURMET_DELIGHT, 3, 2, true, Faction.HEALTHY_OASIS);
        allCards.put(smoothieMage.getName(), smoothieMage);
        allCharacters.add(smoothieMage);
        
        CharacterCard healthMaster = new CharacterCard(
            "健康大師", 6, "【開胃】：為所有友方角色恢復2點生命值。【連擊】：攻擊後，有50%機率再次攻擊。", 
            Rarity.ULTIMATE_TASTE, 4, 4, true, Faction.HEALTHY_OASIS);
        allCards.put(healthMaster.getName(), healthMaster);
        allCharacters.add(healthMaster);
    ...
    private void initializeSpellCards(Map<String, Card> allCards, List<SpellCard> allSpells) {
        ...
        SpellCard fruitBasket = new SpellCard(
            "水果籃", 2, "【開胃】：從牌庫抽一張卡牌。【滋補】：抽到健康綠洲卡牌時，獲得+1/+1。", 
    ...
    private void initializeFieldCards(Map<String, Card> allCards, List<FieldCard> allFieldCards) {
        ...
        // 補充更多場地卡以達到10張
        FieldCard greenSmoothieMaker = FieldCard.createEnvironmentField(
        ...
        FieldCard vegetableGarden = FieldCard.createEnvironmentField(
            "蔬菜園", 3, "【開胃】：從牌庫底抽一張健康綠洲卡牌。【回味】：使一個友方角色獲得+0/+2。", 
        ...
        FieldCard naturalPresservation = FieldCard.createEnvironmentField(
        ...
        FieldCard healingInfusion = FieldCard.createEnvironmentField(
        ...
        FieldCard acupunctureKit = FieldCard.createEnvironmentField(
        ...
        FieldCard organicHotpot = FieldCard.createEnvironmentField(
        ...
        FieldCard healthGarden = FieldCard.createEnvironmentField(
            "健康花園", 3, "每回合開始時，為一個友方角色恢復1點生命值。", 
            Rarity.CASUAL_BITES, 2, Faction.HEALTHY_OASIS);
        allCards.put(healthGarden.getName(), healthGarden);
        allFieldCards.add(healthGarden);
        
        FieldCard smoothieBar = FieldCard.createEnvironmentField(
            "冰沙吧", 2, "使一個友方角色獲得【連擊】效果：攻擊後，有30%機率再次攻擊。", 
            Rarity.CASUAL_BITES, 2, Faction.HEALTHY_OASIS);
        allCards.put(smoothieBar.getName(), smoothieBar);
        allFieldCards.add(smoothieBar);
        
        FieldCard healthCenter = FieldCard.createEnvironmentField(
            "健康中心", 4, "每回合結束時，為所有友方角色恢復1點生命值。", 
            Rarity.GOURMET_DELIGHT, 3, Faction.HEALTHY_OASIS);
        allCards.put(healthCenter.getName(), healthCenter);
        allFieldCards.add(healthCenter);
        
        FieldCard wellnessRetreat = FieldCard.createEnvironmentField(
            "健康療養所", 5, "友方角色獲得+1/+1，且每回合開始時恢復1點生命值。", 
            Rarity.CULINARY_HERITAGE, 4, Faction.HEALTHY_OASIS);
        allCards.put(wellnessRetreat.getName(), wellnessRetreat);
        allFieldCards.add(wellnessRetreat);
        
        FieldCard healthSanctuary = FieldCard.createEnvironmentField(
            "健康聖殿", 6, "所有友方角色獲得【連擊】效果，且每回合開始時恢復2點生命值。", 
            Rarity.ULTIMATE_TASTE, 5, Faction.HEALTHY_OASIS);
        allCards.put(healthSanctuary.getName(), healthSanctuary);
        allFieldCards.add(healthSanctuary);
    }
