...
public class NeutralCardInitializer implements FactionCardInitializer {
    ...
    public void initializeCards(
        ...
        CharacterCard cornKnight = new CharacterCard(
            "玉米金甲騎士 (Corn Golden Armor Knight)", 2, "【酥脆(1)】：減免1點傷害。【彈牙】：每回合可攻擊2次。", 
            Rarity.COMMON, 2, 3, true, Faction.NEUTRAL, 1);
        allCards.put(cornKnight.getName(), cornKnight);
        allCharacters.add(cornKnight);

        CharacterCard potatoGuardian = new CharacterCard(
            "馬鈴薯地底守護者 (Potato Underground Guardian)", 3, "【擺盤】：敵人必須優先攻擊這個單位。【回味】：死亡時為一個友方角色恢復2點生命值。", 
            Rarity.COMMON, 1, 4, false, Faction.NEUTRAL, 2);
        ...
        CharacterCard sweetPotatoMage = new CharacterCard(
            "地瓜甜蜜秘術師 (Sweet Potato Honey Arcanist)", 4, "【開胃】：為一個友方角色恢復2點生命值。【回味】：死亡時抽一張牌。", 
            Rarity.RARE, 3, 4, false, Faction.NEUTRAL, 2);
        ...
        CharacterCard yamPriest = new CharacterCard(
            "山藥靈氣祭司 (Yam Aura Priest)", 5, "【開胃】：為所有友方角色恢復1點生命值。【回味】：死亡時抽兩張牌。", 
            Rarity.RARE, 2, 4, false, Faction.NEUTRAL, 3);
        allCards.put(yamPriest.getName(), yamPriest);
        allCharacters.add(yamPriest);

        CharacterCard burdockKnight = new CharacterCard(
            "牛蒡鐵甲騎士 (Burdock Iron Cavalry)", 4, "【擺盤】：敵人必須優先攻擊這個單位。【彈牙】：每回合可攻擊2次。", 
            Rarity.RARE, 3, 3, false, Faction.NEUTRAL, 2);
        ...
        CharacterCard soyWarrior = new CharacterCard(
            "黃豆爆發戰士 (Soybean Burst Warrior)", 2, "【彈牙】：每回合可攻擊2次。【回味】：死亡時使一個友方角色獲得+1/+1。", 
            Rarity.COMMON, 2, 2, true, Faction.NEUTRAL, 1);
        allCards.put(soyWarrior.getName(), soyWarrior);
        allCharacters.add(soyWarrior);

        CharacterCard blackBeanNinja = new CharacterCard(
            "黑豆暗影忍者 (Black Bean Shadow Ninja)", 3, "【酥脆(1)】：減免1點傷害。【開胃】：獲得+1/+1直到回合結束。", 
            Rarity.RARE, 3, 2, true, Faction.NEUTRAL, 2);
        ...
        CharacterCard redBeanMage = new CharacterCard(
            "紅豆甜蜜巫師 (Red Bean Sweet Wizard)", 3, "【開胃】：為一個友方角色恢復2點生命值。【回味】：死亡時抽一張牌。", 
            Rarity.COMMON, 2, 2, true, Faction.NEUTRAL, 1);
        allCards.put(redBeanMage.getName(), redBeanMage);
        allCharacters.add(redBeanMage);

        CharacterCard mungBeanScout = new CharacterCard(
            "綠豆探路斥候 (Mung Bean Pathfinder)", 2, "【酥脆(1)】：減免1點傷害。【彈牙】：每回合可攻擊2次。", 
            Rarity.COMMON, 2, 1, true, Faction.NEUTRAL, 1);
        ...
        CharacterCard kidneyBeanGuard = new CharacterCard(
            "腰豆曲線衛士 (Kidney Bean Curve Guardian)", 3, "【擺盤】：敵人必須優先攻擊這個單位。【回味】：死亡時使一個友方角色獲得+2/+2。", 
            Rarity.RARE, 1, 4, false, Faction.NEUTRAL, 2);
        ...
        CharacterCard chickpeaArcher = new CharacterCard(
            "鷹嘴豆圓形射手 (Chickpea Round Archer)", 3, "【彈牙】：每回合可攻擊2次。【回味】：死亡時對一個敵方單位造成2點傷害。", 
            Rarity.COMMON, 3, 2, true, Faction.NEUTRAL, 1);
        ...
        CharacterCard lentilWarrior = new CharacterCard(
            "扁豆壓制戰將 (Lentil Suppression Marshal)", 4, "【開胃】：獲得+2/+2直到回合結束。【回味】：死亡時使所有友方角色獲得+1/+1。", 
            Rarity.RARE, 3, 3, false, Faction.NEUTRAL, 2);
        allCards.put(lentilWarrior.getName(), lentilWarrior);
        allCharacters.add(lentilWarrior);

        CharacterCard peaPriest = new CharacterCard(
            "豌豆翠綠聖職者 (Pea Viridian Cleric)", 4, "【開胃】：為所有友方角色恢復1點生命值。【回味】：死亡時抽兩張牌。", 
            Rarity.RARE, 2, 3, false, Faction.NEUTRAL, 3);
        allCards.put(peaPriest.getName(), peaPriest);
        allCharacters.add(peaPriest);

        CharacterCard broadBeanKnight = new CharacterCard(
            "蠶豆重騎兵團長 (Broad Bean Heavy Cavalry Commander)", 5, "【擺盤】：敵人必須優先攻擊這個單位。【彈牙】：每回合可攻擊2次。", 
            Rarity.RARE, 4, 4, false, Faction.NEUTRAL, 3);
        ...
        CharacterCard adzukiBeanMage = new CharacterCard(
            "紅豆魔力元素師 (Adzuki Bean Elemental Mage)", 4, "【開胃】：對所有敵方單位造成1點傷害。【回味】：死亡時使一個友方角色獲得+3/+3。", 
            Rarity.RARE, 3, 3, false, Faction.NEUTRAL, 3);
        ...
        CharacterCard spinachPaladin = new CharacterCard(
            "菠菜鐵翠聖騎士 (Spinach Iron-Green Paladin)", 4, "【擺盤】：敵人必須優先攻擊這個單位。【回味】：死亡時使所有友方角色獲得+1/+1。", 
            Rarity.RARE, 2, 5, false, Faction.NEUTRAL, 3);
        ...
        CharacterCard arugulaPriest = new CharacterCard(
            "芝麻菜清香祭司 (Arugula Fragrant Cleric)", 4, "【開胃】：為所有友方角色恢復1點生命值。【回味】：死亡時使一個友方角色獲得+2/+2。", 
            Rarity.RARE, 2, 3, false, Faction.NEUTRAL, 3);
        ...
        CharacterCard mustardKnight = new CharacterCard(
            "芥菜辛辣騎兵 (Mustard Spicy Cavalier)", 5, "【擺盤】：敵人必須優先攻擊這個單位。【彈牙】：每回合可攻擊2次。", 
            Rarity.RARE, 4, 4, false, Faction.NEUTRAL, 3);
        allCards.put(mustardKnight.getName(), mustardKnight);
        allCharacters.add(mustardKnight);

        CharacterCard chardMage = new CharacterCard(
            "甜菜彩虹魔導師 (Swiss Chard Rainbow Archmage)", 4, "【開胃】：對一個敵方單位造成2點傷害。【回味】：死亡時使所有友方角色獲得+1/+1。", 
            Rarity.RARE, 3, 3, false, Faction.NEUTRAL, 3);
        ...
        CharacterCard pumpkinGiant = new CharacterCard(
            "南瓜重甲巨人 (Pumpkin Heavy Armored Giant)", 5, "【擺盤】：敵人必須優先攻擊這個單位。【回味】：死亡時對所有敵方單位造成2點傷害。", 
            Rarity.RARE, 3, 6, false, Faction.NEUTRAL, 4);
        ...
        CharacterCard cucumberArcher = new CharacterCard(
            "黃瓜清脆弓箭手 (Cucumber Crisp Archer)", 3, "【彈牙】：每回合可攻擊2次。【回味】：死亡時抽一張牌。", 
            Rarity.COMMON, 3, 2, true, Faction.NEUTRAL, 1);
        ...
        CharacterCard watermelonGuard = new CharacterCard(
            "西瓜厚皮防衛官 (Watermelon Thick-Rind Defender)", 4, "【擺盤】：敵人必須優先攻擊這個單位。【回味】：死亡時為所有友方角色恢復2點生命值。", 
            Rarity.RARE, 2, 6, false, Faction.NEUTRAL, 3);
        ...
        CharacterCard cantaloupeWarrior = new CharacterCard(
            "哈密瓜甜心突擊兵 (Cantaloupe Sweetheart Raider)", 4, "【開胃】：獲得+2/+2直到回合結束。【回味】：死亡時使一個友方角色獲得+2/+2。", 
            Rarity.RARE, 3, 4, false, Faction.NEUTRAL, 3);
        ...
        CharacterCard honeydewMage = new CharacterCard(
            "蜜瓜蜜霧術士 (Honeydew Mist Conjurer)", 3, "【開胃】：為一個友方角色恢復2點生命值。【回味】：死亡時抽兩張牌。", 
            Rarity.RARE, 2, 2, true, Faction.NEUTRAL, 2);
        ...
        CharacterCard bitterGourdScout = new CharacterCard(
            "苦瓜凜冽偵察兵 (Bitter Gourd Astringent Scout)", 2, "【酥脆(1)】：減免1點傷害。【彈牙】：每回合可攻擊2次。", 
            Rarity.COMMON, 2, 1, true, Faction.NEUTRAL, 1);
        ...
        CharacterCard winterMelonPriest = new CharacterCard(
            "冬瓜清涼牧師 (Winter Melon Cooling Priest)", 4, "【開胃】：為所有友方角色恢復1點生命值。【回味】：死亡時使一個友方角色獲得+3/+3。", 
            Rarity.RARE, 2, 4, false, Faction.NEUTRAL, 3);
        ...
        CharacterCard luffaKnight = new CharacterCard(
            "絲瓜網紋騎士 (Luffa Netted Knight)", 5, "【擺盤】：敵人必須優先攻擊這個單位。【彈牙】：每回合可攻擊2次。", 
            Rarity.RARE, 4, 4, false, Faction.NEUTRAL, 4);
        allCards.put(luffaKnight.getName(), luffaKnight);
        allCharacters.add(luffaKnight);

        CharacterCard bottleGourdMage = new CharacterCard(
            "葫蘆容器術師 (Bottle Gourd Container Mage)", 4, "【開胃】：對一個敵方單位造成2點傷害。【回味】：死亡時使所有友方角色獲得+1/+1。", 
            Rarity.RARE, 3, 3, false, Faction.NEUTRAL, 3);
        ...
        CharacterCard snakeGourdArcher = new CharacterCard(
            "蛇瓜曲線射手 (Snake Gourd Serpentine Archer)", 3, "【彈牙】：每回合可攻擊2次。【回味】：死亡時對一個敵方單位造成2點傷害。", 
            Rarity.COMMON, 3, 2, true, Faction.NEUTRAL, 1);
        ...
        CharacterCard mushroomShaman = new CharacterCard(
            "香菇靈能薩滿 (Shiitake Spirit Shaman)", 4, "【開胃】：為所有友方角色恢復1點生命值。【回味】：死亡時使一個友方角色獲得+2/+2。", 
            Rarity.RARE, 2, 3, false, Faction.NEUTRAL, 3);
        ...
        CharacterCard enokiMage = new CharacterCard(
            "金針菇纖細法師 (Enoki Slender Mage)", 3, "【酥脆(1)】：減免1點傷害。【開胃】：抽一張牌。", 
            Rarity.COMMON, 2, 2, true, Faction.NEUTRAL, 1);
        allCards.put(enokiMage.getName(), enokiMage);
        allCharacters.add(enokiMage);

        CharacterCard shiitakeGuard = new CharacterCard(
            "香菇厚實守護者 (Shiitake Fleshy Protector)", 3, "【擺盤】：敵人必須優先攻擊這個單位。【回味】：死亡時為一個友方角色恢復3點生命值。", 
            Rarity.COMMON, 1, 5, false, Faction.NEUTRAL, 2);
        ...
        CharacterCard oysterMushroomArcher = new CharacterCard(
            "蠔菇扇形射擊手 (Oyster Mushroom Fan Shooter)", 3, "【彈牙】：每回合可攻擊2次。【回味】：死亡時使一個友方角色獲得+1/+1。", 
            Rarity.COMMON, 3, 2, true, Faction.NEUTRAL, 1);
        ...
        CharacterCard kingOysterWarrior = new CharacterCard(
            "杏鮑菇巨柱戰士 (King Oyster Pillar Warrior)", 4, "【開胃】：獲得+2/+2直到回合結束。【回味】：死亡時對所有敵方單位造成1點傷害。", 
            Rarity.RARE, 3, 4, false, Faction.NEUTRAL, 3);
        ...
        CharacterCard reishiPriest = new CharacterCard(
            "靈芝長壽祭司 (Reishi Longevity Priest)", 4, "【開胃】：為所有友方角色恢復1點生命值。【回味】：死亡時使一個友方角色獲得+2/+2。", 
            Rarity.RARE, 2, 3, false, Faction.NEUTRAL, 3);
        ...
        CharacterCard lionManeKnight = new CharacterCard(
            "猴頭菇獅鬃騎士 (Lion's Mane Flowing Cavalier)", 5, "【擺盤】：敵人必須優先攻擊這個單位。【彈牙】：每回合可攻擊2次。", 
            Rarity.RARE, 4, 4, false, Faction.NEUTRAL, 4);
        ...
        CharacterCard cordycepsMage = new CharacterCard(
            "蟲草神秘魔導士 (Cordyceps Mystic Archmage)", 4, "【開胃】：對一個敵方單位造成2點傷害。【回味】：死亡時使所有友方角色獲得+1/+1。", 
            Rarity.RARE, 3, 3, false, Faction.NEUTRAL, 3);
        ...
        CharacterCard blackPepperWarrior = new CharacterCard(
            "黑胡椒尖刺勇士 (Black Pepper Spiked Champion)", 2, "無特性", 
            Rarity.COMMON, 3, 1, true, Faction.NEUTRAL, 1);
        ...
        CharacterCard whitePepperArcher = new CharacterCard(
            "白胡椒靜謐神射手 (White Pepper Silent Marksman)", 3, "【彈牙】：每回合可攻擊2次。", 
            Rarity.COMMON, 3, 2, true, Faction.NEUTRAL, 1);
        ...
        CharacterCard cinnamonGuard = new CharacterCard(
            "肉桂香氣守衛隊長 (Cinnamon Fragrant Guard Captain)", 3, "【擺盤】：敵人必須優先攻擊這個單位。", 
            Rarity.COMMON, 2, 4, false, Faction.NEUTRAL, 2);
        allCards.put(cinnamonGuard.getName(), cinnamonGuard);
        allCharacters.add(cinnamonGuard);

        CharacterCard cuminMage = new CharacterCard(
            "孜然芳香術士 (Cumin Aromatic Conjurer)", 3, "【開胃】：使一個友方角色獲得+1/+1。", 
            Rarity.RARE, 2, 2, true, Faction.NEUTRAL, 1);
        allCards.put(cuminMage.getName(), cuminMage);
        allCharacters.add(cuminMage);

        CharacterCard starAniseKnight = new CharacterCard(
            "八角星芒騎士團長 (Star Anise Stellar Commander)", 4, "【酥脆(2)】：減免2點傷害。", 
            Rarity.RARE, 3, 3, false, Faction.NEUTRAL, 2);
        ...
        CharacterCard mustardAssassin = new CharacterCard(
            "芥末熱辣刺客大師 (Mustard Spicy Assassin Master)", 3, "【回味】：死亡時對一個敵方單位造成2點傷害。", 
            Rarity.RARE, 4, 1, true, Faction.NEUTRAL, 3);
        ...
        CharacterCard turmericPriest = new CharacterCard(
            "薑黃金光療癒師 (Turmeric Golden Healer)", 4, "【滋補】：回合結束時恢復2點生命值。", 
            Rarity.RARE, 2, 3, false, Faction.NEUTRAL, 2);
        ...
        CharacterCard rosemaryGuardian = new CharacterCard(
            "迷迭香草葉守護者 (Rosemary Herbal Guardian)", 2, "無特性", 
            Rarity.COMMON, 2, 2, false, Faction.NEUTRAL, 1);
        ...
        CharacterCard basilMonk = new CharacterCard(
            "羅勒清香修道士 (Basil Refreshing Monk)", 3, "【現炸】：可以在出場的回合立即攻擊。", 
            Rarity.RARE, 3, 2, true, Faction.NEUTRAL, 2);
        allCards.put(basilMonk.getName(), basilMonk);
        allCharacters.add(basilMonk);

        CharacterCard herbMaster = new CharacterCard(
            "香草植物學宗師 (Herb Botanical Grandmaster)", 5, "【開胃】：為所有友方角色恢復1點生命值。【回味】：死亡時抽兩張牌。", 
            Rarity.LEGENDARY, 3, 4, false, Faction.NEUTRAL, 5);
        ...
        CharacterCard plainRootVegetable = new CharacterCard(
            "紅蘿蔔前線士兵 (Carrot Frontline Soldier)", 1, "無特性", 
            Rarity.COMMON, 2, 1, true, Faction.NEUTRAL, 1);
        ...
        CharacterCard plainStarAnise = new CharacterCard(
            "八角星形大使 (Star Anise Stellar Ambassador)", 5, "無特性", 
            Rarity.RARE, 5, 5, true, Faction.NEUTRAL, 4);
        ...
        SpellCard wallRepair = new SpellCard(
            ...
            Rarity.COMMON, SpellType.HEALING, 1);
        ...
        SpellCard emergencyRepair = new SpellCard(
            ...
            Rarity.RARE, SpellType.HEALING, 3);
        ...
        SpellCard masterRepair = new SpellCard(
            ...
            Rarity.RARE, SpellType.HEALING, 4);
        ...
        SpellCard divineHealing = new SpellCard(
            ...
            Rarity.LEGENDARY, SpellType.HEALING, 5);
        ...
        SpellCard quickTransfer = new SpellCard(
            ...
            Rarity.COMMON, SpellType.SPECIAL, 1);
        ...
        SpellCard massTransfer = new SpellCard(
            ...
            Rarity.RARE, SpellType.SPECIAL, 3);
        ...
        SpellCard emergencyEvacuation = new SpellCard(
            ...
            Rarity.RARE, SpellType.SPECIAL, 2);
        ...
        SpellCard strategicRetreat = new SpellCard(
            ...
            Rarity.LEGENDARY, SpellType.SPECIAL, 4);
        ...
        SpellCard foodSupply = new SpellCard(
            ...
            Rarity.COMMON, SpellType.DRAW, 1);
        ...
        SpellCard foodPreservation = new SpellCard(
            ...
            Rarity.COMMON, SpellType.BUFF, 1);
        ...
        SpellCard foodCurse = new SpellCard(
            ...
            Rarity.COMMON, SpellType.DEBUFF, 1);
        ...
        SpellCard foodPoison = new SpellCard(
            ...
            Rarity.RARE, SpellType.DEBUFF, 2);
        ...
        SpellCard foodPlague = new SpellCard(
            ...
            Rarity.RARE, SpellType.DEBUFF, 3);
        ...
        SpellCard foodMiracle = new SpellCard(
            ...
            Rarity.LEGENDARY, SpellType.BUFF, 4);
        ...
        SpellCard foodApocalypse = new SpellCard(
            ...
            Rarity.LEGENDARY, SpellType.DEBUFF, 5);
        ...
        SpellCard rootVegetableGrowth = new SpellCard(
            ...
            Rarity.COMMON, SpellType.SPECIAL, 2);
        ...
        SpellCard leafyRegeneration = new SpellCard(
            ...
            Rarity.COMMON, SpellType.HEALING, 2);
        ...
        FieldCard vegetableGarden = FieldCard.createEnvironmentField(
            ...
            Rarity.COMMON, 1, Faction.NEUTRAL, 2);
        ...
        FieldCard fruitOrchard = FieldCard.createEnvironmentField(
            ...
            Rarity.RARE, 2, Faction.NEUTRAL, 3);
        ...
        FieldCard mushroomForest = FieldCard.createEnvironmentField(
            ...
            Rarity.RARE, 3, Faction.NEUTRAL, 3);
        ...
        FieldCard grainField = FieldCard.createEnvironmentField(
            ...
            Rarity.COMMON, 1, Faction.NEUTRAL, 1);
        ...
        FieldCard herbGarden = FieldCard.createEnvironmentField(
            ...
            Rarity.RARE, 2, Faction.NEUTRAL, 2);
        ...
        FieldCard rootCellar = FieldCard.createEnvironmentField(
            ...
            Rarity.COMMON, 2, Faction.NEUTRAL, 2);
        ...
        FieldCard beanField = FieldCard.createEnvironmentField(
            ...
            Rarity.RARE, 1, Faction.NEUTRAL, 1);
        ...
        FieldCard ancientGarden = FieldCard.createEnvironmentField(
            ...
            Rarity.LEGENDARY, 4, Faction.NEUTRAL, 5);
        ...
        FieldCard sacredGrove = FieldCard.createEnvironmentField(
            ...
            Rarity.LEGENDARY, 3, Faction.NEUTRAL, 3);
